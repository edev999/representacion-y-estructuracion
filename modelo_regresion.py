...
# 1. Cargar dataset y limpiar datos básicos
...
# 7. Preparar dataset para visualización
df_plot = df.copy()
...
# 8. Visualización: valor real vs valor estimado
fig = px.scatter(
    df_plot,
...
# 9. Evaluar precisión del modelo con el conjunto de validación
